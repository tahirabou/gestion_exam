...
<table class="table table-bordered table-dark">
    ...
    ?>
                ...
                <td>
                  <a id="btnn" href="../includes/teacher_del.php?id=<?php echo $id;?>">Supprimer <i class="fa fa-trash"></i></a> &nbsp
                <a  id="btnn" href="../includes/teacher_edit.php?id=<?php echo $id;?>"> Modifier<i class="fa fa-edit"></i></a>
